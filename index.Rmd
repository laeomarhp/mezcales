--- 
title: "Mezcal, la bebida espirituosa más compleja del mundo"
...
La palabra *mezcal* tiene su origen en la lengua náhuatl. Proviene del término “mexcalli”, compuesto por “metl”, que significa maguey, e “ixcalli”, que significa cocido. En conjunto, el concepto hace referencia al maguey cocido, el cual ha sido utilizado por los pobladores de Mesoamérica como fuente de alimento desde hace más de 9 mil años.

En Mesoamérica, los códices y las fuentes de la época colonial documentan una amplia diversidad de bebidas fermentadas producidas antes del contacto con los europeos, particularmente aquellas elaboradas a partir del maguey. Estas bebidas no solo cumplían funciones alimenticias, sino también simbólicas y rituales, formando parte de ceremonias religiosas a las que, en muchos casos, únicamente tenían acceso las élites, como nobles y sacerdotes.

La producción de destilados de agave comenzó a expandirse de manera significativa a partir del siglo XVII, cuando las técnicas y herramientas de destilación se difundieron en distintas regiones. Cada comunidad adaptó el proceso de elaboración a sus condiciones geográficas, culturales y tecnológicas, lo que dio lugar a una notable diversidad de métodos productivos. Así, cada región fue construyendo su propia identidad en torno al mezcal, generando una riqueza de estilos, sabores y reputaciones asociadas a prácticas locales.

Durante el siglo XVIII, la producción de mezcal se consolidó como una actividad económica relevante en diversas regiones, particularmente en aquellas vinculadas a la minería, donde su consumo se incrementó entre los trabajadores. No obstante, durante el periodo de la Nueva España, la Corona española prohibió su producción al considerarlo perjudicial para la salud pública y, sobre todo, por afectar los intereses comerciales derivados de la importación de bebidas alcohólicas europeas. A pesar de estas restricciones, el mezcal logró subsistir en haciendas, comunidades agrícolas y pequeños sistemas productivos, donde se preservaron los conocimientos tradicionales transmitidos de generación en generación.

Hacia finales del siglo XIX, en el contexto del México independiente y del impulso al desarrollo capitalista, se introdujeron en Jalisco técnicas modernas de destilación. El mezcal producido en la región de Tequila adoptó estos avances tecnológicos, permitiendo aumentar los volúmenes de producción y dando origen a la consolidación del denominado “vino de mezcal”, posteriormente conocido como tequila.

En este sentido, como explica @Bowen2015 en su obra *Divided Spirits: Tequila, Mezcal, and the Politics of Production*, el mezcal producido en la región de Tequila alcanzó popularidad en Estados Unidos gracias a su presencia en ferias internacionales y al desarrollo de infraestructura regional, lo que derivó en su industrialización. Este proceso culminó con el reconocimiento del tequila como producto con Denominación de Origen (DO) en 1974, siendo el primero fuera de Europa. Por su parte, la denominación de origen del mezcal fue establecida en 1994, caracterizándose por mantener una producción más limitada y una mayor diversidad de especies de agave.

Sin embargo, la denominación de origen ha generado debates importantes. Si bien su objetivo es proteger el producto, su territorio y sus procesos, en la práctica también ha contribuido, en ciertos casos, a la homogeneización de las especies de agave, al desplazamiento de pequeños productores y a la reducción de la diversidad sensorial de los destilados. Esta diversidad es, precisamente, resultado de decisiones productivas artesanales y de condiciones microambientales específicas.

A diferencia del tequila, cuyo estándar restringe su producción a una sola especie (*Agave tequilana*), el mezcal permite el uso de múltiples especies de agave tradicionalmente empleadas. No obstante, el concepto de “terruño” del mezcal ha sido, en gran medida, construido y valorizado por consumidores de alto poder adquisitivo, quienes, aunque valoran los productos artesanales y su carga cultural, suelen estar alejados de las realidades sociales y económicas de los productores. Estos consumidores están dispuestos a pagar precios elevados por productos percibidos como auténticos, provenientes de territorios remotos y asociados a nociones de tradición, identidad y espiritualidad.
...
```{r, out.width='75%', fig.align='center', fig.cap='Producción por año (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('ProduccionPorAño2021.jpg')
```

```{r, out.width='75%', fig.align='center', fig.cap='Detalle de la producción (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('DetalleProduccion2021.jpg')
```

La producción nacional de mezcal 2021 referido a 45% Alc. Vol. equivale a 8´099,591.00 litros, siendo la categoría; Mezcal artesanal la principal producida con el 88.92% [@Comercam2022].

```{r, out.width='75%', fig.align='center', fig.cap='Producción por categoría (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('ProduccionCategorias2021.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Producción por clase (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('ProduccionClase2021.jpg')
```


Maguey espadín la principal empleada para la producción con el 88.11% [@Comercam2022].

```{r, out.width='75%', fig.align='center', fig.cap='Producción por especie (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('ProduccionEspecie2021.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Envasado para mercado nacional por año (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('EnvasadoNacional2021.jpg')
```


```{r, out.width='75%', fig.align='center', fig.cap='Detalle de envasado para mercado nacional por año (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('DetalleEnvasadoNacional2021.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Envasado para mercado de exportación por año (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('EnvasadoExportacion2021.jpg')
```


```{r, out.width='75%', fig.align='center', fig.cap='Detalle de envasado para mercado de exportación por año (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('DetalleEnvasadoExportacion2021.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Indicadores del sector mezcal'}
knitr::include_graphics('IndicadoresSector2021.jpg')
```

```{r, out.width='75%', fig.align='center', fig.cap='Historico envasado (Referido a 45% Alc. Vol.)'}
knitr::include_graphics('HistoricoEnvasado2021.jpg')
```


```{r, out.width='75%', fig.align='center', fig.cap='Historico Del Valor Estimado De La Categoría (Millones De Pesos)'}
knitr::include_graphics('HistoricoValor2021.jpg')
```
...
La Norma Oficial Mexicana (NOM) establece las características y especificaciones que debe cumplir la bebida alcohólica destilada denominada Mezcal para su producción, envasado y comercialización, se mencionan los puntos de mayor importancia [@Nom070]:
...
```{r, out.width='75%', fig.align='center', fig.cap='Elementos obligatorios en el etiquetado para la venta nacional'}
knitr::include_graphics('Etiqueta_Mezcal.jpg')
```
...
En seguida se describen algunas de las especies de agave más comunes para hacer mezcal. La lista no es exhaustiva, sino más bien muestra las tendencias en el mercado actual. Como se describió anteriormente, cada planta, incluso las de la misma especie, puede producir resultados diferentes dependiendo de dónde se cultivó y cómo se procesó [@Janzen2017].
...
```{r, out.width='75%', fig.align='center', fig.cap='Maguey Espadín'}
knitr::include_graphics('Espadin.jpeg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Maguey Cenizo'}
knitr::include_graphics('Cenizo.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Maguey Cupreata'}
knitr::include_graphics('Cupreata.jpeg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Maguey Tobalá'}
knitr::include_graphics('Tobala.jpg')
```

## Maguey Azúl (A. Tequilana)

```{r, out.width='75%', fig.align='center', fig.cap='Maguey Azúl'}
knitr::include_graphics('Azul.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Maguey Cuishe'}
knitr::include_graphics('Cuishe.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Parcela de magueyes en Ex-hacienda Zacapendo'}
knitr::include_graphics('MateriaPrima.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Brote del quiote'}
knitr::include_graphics('Quiote.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Jima del maguey en Ex-hacienda Zacapaendo'}
knitr::include_graphics('Jima.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Traslado de maguey'}
knitr::include_graphics('Traslado.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Encendido de horno en Ex-hacienda Zacapendo'}
knitr::include_graphics('EncendidoHorno.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Carga de horno en Ex-hacienda Zacapendo'}
knitr::include_graphics('CargaHorno.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Destapado de horno en Ex-hacienda Zacapendo'}
knitr::include_graphics('DestapadoHorno.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Molienda ancestral en Ex-hacienda Zacapendo'}
knitr::include_graphics('MoliendaAncestral.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Molino moderno en Ex-hacienda Zacapendo'}
knitr::include_graphics('Molino.jpg')
```
...
En esta etapa se realiza el cambio bioquímico de los azúcares reductores provenientes del agave en alcohol (principalmente etanol) y compuestos volátiles. La fermentación puede dividirse en dos subetapas [@Ciatej2014]: 
...
La destilación tradicional (con alambiques de cobre) comprende dos etapas [@Ciatej2014]:
...
```{r, out.width='75%', fig.align='center', fig.cap='Destilación artesanal en Ex-hacienda Zacapendo'}
knitr::include_graphics('AlambiqueArtesanal.jpg')
```
...
```{r, out.width='75%', fig.align='center', fig.cap='Añejamiento del mezcal en Ex-hacienda Zacapendo'}
knitr::include_graphics('Añejamiento.jpg')
```

### Dilución del destilado rectificado al grado comercial 

Una vez que se ha definido el grado alcohólico del producto a envasar del rectificado obtenido de la segunda destilación, se debe disponer de la cantidad de agua necesaria así como revisar la calidad de esta agua de dilución. Las características del agua de dilución son en primer lugar, que sea agua potable (apta para consumo humano) y en segundo, que sea desmineralizada. Esta última característica es crítica ya que permitirá que el mezcal sea estable y no presente alguna turbiedad una vez envasado. La cantidad de agua necesaria, puede calcularse a partir de conocer el volumen de litros de mezcal de alta concentración, de su grado alcohólico y del grado alcohólico al que se pretende dejar el volumen de mezcal diluido [@Ciatej2014].

```{r, out.width='75%', fig.align='center', fig.cap='Rectificadora en Ex-hacienda Zacapendo'}
knitr::include_graphics('Rectificadora.jpg')
```
...
Para conocer el color del mezcal, solo se lleva la copa a la altura de los ojos para asignarle algún color, transparencia y brillo al producto [@Sauza2020]. 

## Cuerpo 

Para conocer el cuerpo, se agita la copa asegurándo de que el líquido se adhiera a las paredes formando una corona en la parte superior. De esta corona se desprenderán las lágrimas o piernas. Después, se podrá definir el cuerpo del mezcal como ligero, medio o entero, esto dependerá de que tan rápido desciendan las gotas y de que tan pegadas estén una de la otra [@Sauza2020]. 

## Aroma

Se dice que en los mezcales existen muchos aromas. Es un poco complicado poder percibirlos todos, por eso es mejor concentrarse en las notas primarias, que son aquellas dadas por el proceso. Éstas se pueden percibir, entre muchos otros, como [@Sauza2020]:
...
Para este último paso, es importante conocer los sabores que se perciben en boca y que son [@Sauza2020]:          
